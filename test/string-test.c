...
static void test_string_toFloat (void) {
  ...
  ASSERT_NO_THROW(TO_FLOAT1, {
    assert(((void) "Converts to float zero", fabs(d4_str_toFloat(&d4_err_state, 0, 0, s1) - 0) < 0.000001));
    assert(((void) "Converts to float single digit", fabs(d4_str_toFloat(&d4_err_state, 0, 0, s2) - 1) < 0.000001));
    assert(((void) "Converts to float with floating point", fabs(d4_str_toFloat(&d4_err_state, 0, 0, s3) - 1.23) < 0.000001));
    assert(((void) "Converts to float max value", fabs(d4_str_toFloat(&d4_err_state, 0, 0, s4) - 1.7976931348623157e+308) < 0.000001));
    assert(((void) "Converts to float only positive exponent", fabs(d4_str_toFloat(&d4_err_state, 0, 0, s5) - 3e+38) < 0.000001));
    assert(((void) "Converts to float smallest value", fabs(d4_str_toFloat(&d4_err_state, 0, 0, s6) - 2.2250738585072014e-308) < 0.000001));
    assert(((void) "Converts to float only negative exponent", fabs(d4_str_toFloat(&d4_err_state, 0, 0, s7) - 1E-38) < 0.000001));
    assert(((void) "Converts to float min value", fabs(d4_str_toFloat(&d4_err_state, 0, 0, s8) - -1.7976931348623157e+308) < 0.000001));
  });
...
static void test_string_toF32 (void) {
  ...
  ASSERT_NO_THROW(TO_FLOAT32_1, {
    assert(((void) "Converts to f32 zero", fabs(d4_str_toF32(&d4_err_state, 0, 0, s1) - 0.0f) < 0.000001));
    assert(((void) "Converts to f32 single digit", fabs(d4_str_toF32(&d4_err_state, 0, 0, s2) - 1.0f) < 0.000001));
    assert(((void) "Converts to f32 with floating point", fabs(d4_str_toF32(&d4_err_state, 0, 0, s3) - 1.23f) < 0.000001));
    assert(((void) "Converts to f32 max value", fabs(d4_str_toF32(&d4_err_state, 0, 0, s4) - 3.40282347e+38f) < 0.000001));
    assert(((void) "Converts to f32 only positive exponent", fabs(d4_str_toF32(&d4_err_state, 0, 0, s5) - 3e+38f) < 0.000001));
    assert(((void) "Converts to f32 smallest value", fabs(d4_str_toF32(&d4_err_state, 0, 0, s6) - 1.17549435e-38f) < 0.000001));
    assert(((void) "Converts to f32 only negative exponent", fabs(d4_str_toF32(&d4_err_state, 0, 0, s7) - 1E-37f) < 0.000001));
    assert(((void) "Converts to f32 min value", fabs(d4_str_toF32(&d4_err_state, 0, 0, s8) - -3.40282347e+38f) < 0.000001));
  });
...
static void test_string_toF64 (void) {
  ...
  ASSERT_NO_THROW(TO_FLOAT64_1, {
    assert(((void) "Converts to f64 zero", fabs(d4_str_toF64(&d4_err_state, 0, 0, s1) - 0) < 0.000001));
    assert(((void) "Converts to f64 single digit", fabs(d4_str_toF64(&d4_err_state, 0, 0, s2) - 1) < 0.000001));
    assert(((void) "Converts to f64 with floating point", fabs(d4_str_toF64(&d4_err_state, 0, 0, s3) - 1.23) < 0.000001));
    assert(((void) "Converts to f64 max value", fabs(d4_str_toF64(&d4_err_state, 0, 0, s4) - 1.7976931348623157e+308) < 0.000001));
    assert(((void) "Converts to f64 only positive exponent", fabs(d4_str_toF64(&d4_err_state, 0, 0, s5) - 3e+38) < 0.000001));
    assert(((void) "Converts to f64 smallest value", fabs(d4_str_toF64(&d4_err_state, 0, 0, s6) - 2.2250738585072014e-308) < 0.000001));
    assert(((void) "Converts to f64 only negative exponent", fabs(d4_str_toF64(&d4_err_state, 0, 0, s7) - 1E-38) < 0.000001));
    assert(((void) "Converts to f64 min value", fabs(d4_str_toF64(&d4_err_state, 0, 0, s8) - -1.7976931348623157e+308) < 0.000001));
  });
