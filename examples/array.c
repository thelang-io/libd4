...
int main (void) {
  ...
  the_arr_int_push(&a6, 1, *the_arr_int_at(&the_err_state, 0, 0, a6, 0));
  the_arr_int_push(&a6, 2, *the_arr_int_at(&the_err_state, 0, 0, a6, 1), *the_arr_int_at(&the_err_state, 0, 0, a6, 2));
