...
ExternalProject_Add(
  ...
  BUILD_BYPRODUCTS
    "${OpenSSL_INSTALL_DIR}/lib/libcrypto.3${CMAKE_SHARED_LIBRARY_SUFFIX}"
    "${OpenSSL_INSTALL_DIR}/lib/libssl.3${CMAKE_SHARED_LIBRARY_SUFFIX}"
    "${OpenSSL_INSTALL_DIR}/lib/libcrypto${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${OpenSSL_INSTALL_DIR}/lib/libssl${CMAKE_STATIC_LIBRARY_SUFFIX}"
  CONFIGURE_COMMAND "${OpenSSL_SOURCE_DIR}/config" no-docs no-tests "--prefix=${OpenSSL_INSTALL_DIR}" "--openssldir=${OpenSSL_INSTALL_DIR}"
  BUILD_COMMAND make -j${N}
  INSTALL_COMMAND make -j${N} install_sw
  TEST_COMMAND ""
  UPDATE_COMMAND ""
)
...
set_property(TARGET OpenSSL::SSL PROPERTY IMPORTED_LOCATION "${OpenSSL_INSTALL_DIR}/lib/libssl.3${CMAKE_SHARED_LIBRARY_SUFFIX}")
set_property(TARGET OpenSSL::SSL PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${OpenSSL_INCLUDE_DIR}")
add_dependencies(OpenSSL::SSL OpenSSL)

add_library(OpenSSL::Crypto SHARED IMPORTED GLOBAL)
set_property(TARGET OpenSSL::Crypto PROPERTY IMPORTED_LOCATION "${OpenSSL_INSTALL_DIR}/lib/libcrypto.3${CMAKE_SHARED_LIBRARY_SUFFIX}")
