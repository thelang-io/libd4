...
if (MSVC)
  list(APPEND LIBD4_CMAKE_FLAGS "/we4057")
  list(APPEND LIBD4_CMAKE_FLAGS "/we4244")
  list(APPEND LIBD4_CMAKE_FLAGS "/we4295")
  list(APPEND LIBD4_CMAKE_FLAGS "/we4310")
  list(APPEND LIBD4_CMAKE_FLAGS "/we4706")
else ()
...
if (CMAKE_PROJECT_NAME STREQUAL PROJECT_NAME AND LIBD4_COVERAGE)
  if (MSVC)
    list(APPEND LIBD4_CMAKE_FLAGS "/Od")
    list(APPEND LIBD4_CMAKE_FLAGS "/Zi")
  else ()
...
if (MSVC)
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} /W4 ${LIBD4_CMAKE_FLAGS}")
else ()
