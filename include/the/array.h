...
#define THE_ARRAY_DEFINE(element_type_name, element_type) \
  THE_FUNCTION_DEFINE_WITH_PARAMS(s, bool, FP3##element_type_name) \
  THE_FUNCTION_DEFINE_WITH_PARAMS(s, void, FP3##element_type_name##FP3int) \
  THE_FUNCTION_DEFINE_WITH_PARAMS(s, int, FP3##element_type_name##FP3##element_type_name) \
  \
...
//
//
//bool the_arr_##element_type_name##_eq (the_arr_##element_type_name##_t n1, the_arr_##element_type_name##_t n2) {
//  bool r = n1.l == n2.l;
//  if (r) {
...
//}
//
//the_arr_##element_type_name##_t the_arr_##element_type_name##_filter (err_state_t *state, int line, int col, the_arr_##element_type_name##_t self, " + param1TypeInfo.typeCode + "n1) {
//  size_t l = 0;
...
//}
//
//elementTypeInfo.typeRefCode + typeName + "_first (err_state_t *state, int line, int col, the_arr_##element_type_name##_t *self) {
//  if (self->l == 0) {
...
//
//
//void the_arr_##element_type_name##_forEach (err_state_t *state, int line, int col, the_arr_##element_type_name##_t self, " + param1TypeInfo.typeCode + "n1) {
//  for (size_t i = 0; i < self.l; i++) {
...
//}
//
//the_str_t the_arr_##element_type_name##_join (the_arr_##element_type_name##_t n, unsigned char o1, the_str_t n1) {
...
//}
//
//elementTypeInfo.typeRefCode + typeName + "_last (err_state_t *state, int line, int col, the_arr_##element_type_name##_t *self) {
//  if (self->l == 0) {
...
//}
//
//size_t the_arr_##element_type_name##_len (the_arr_##element_type_name##_t n) {
//  size_t l = n.l;
//  " + this->_genFreeFn(type, CodegenASTExprAccess::create("n"))->str() + ";
//  return l;
//}
//
//the_arr_##element_type_name##_t *the_arr_##element_type_name##_merge (the_arr_##element_type_name##_t *self, " + param1TypeInfo.typeCode + "n1) {
//  size_t k = self->l;
//  self->l += n1.l;
...
//}
//
//bool the_arr_##element_type_name##_ne (the_arr_##element_type_name##_t n1, the_arr_##element_type_name##_t n2) {
//  bool r = n1.l != n2.l;
//  if (!r) {
//    for (size_t i = 0; i < n1.l; i++) {
//      if (" + this->_genEqFn(elementTypeInfo.type, cEq1, cEq2, true)->str() + ") {
...
//}
//
//elementTypeInfo.typeCode + typeName + "_pop (the_arr_##element_type_name##_t *n) {
//  n->l--;
//  return n->d[n->l];
//}
//
//void the_arr_##element_type_name##_push (the_arr_##element_type_name##_t *n, the_arr_##element_type_name##_t m) {
//  if (m.l == 0) return;
//  n->l += m.l;
...
//}
//
//the_arr_##element_type_name##_t the_arr_##element_type_name##_realloc (the_arr_##element_type_name##_t n1, const the_arr_##element_type_name##_t n2) {
//  " + this->_genFreeFn(type, CodegenASTExprAccess::create("n1"))->str() + ";
//  return n2;
//}
//
