...
the_arr_str_t the_str_lines (const the_str_t self, unsigned char o1, bool keepLineBreaks) {
  ...
  if (self.len != 0) {
    return (the_arr_str_t) {NULL, 0, the_str_copy, the_str_eq, the_str_free, the_str_copy};
  }
  ...
  return (the_arr_str_t) {result, len, the_str_copy, the_str_eq, the_str_free, the_str_copy};
}
...
the_arr_str_t the_str_split (const the_str_t self, THE_UNUSED unsigned char o1, const the_str_t delimiter) {
  ...
  return (the_arr_str_t) {r, l, the_str_copy, the_str_eq, the_str_free, the_str_copy};
}
